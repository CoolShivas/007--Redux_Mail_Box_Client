...
const Sentbox = () => {
        ...
        const fetchSentboxEmailFromServer = async () => {
            ...
            try {
                ...
                const response = await fetch(
                    `https://mailboxclient-ad1a1-default-rtdb.firebaseio.com/boxMail/${senderEmail}/sendbox.json`
                );
    ...
    const handlerOnDeleteBtn = async (arr) => {
        try {
            const res = await fetch(`https://mailboxclient-ad1a1-default-rtdb.firebaseio.com/boxMail/${senderEmail}/sendbox/${arr}.json`, {
                method: "DELETE"
            });
