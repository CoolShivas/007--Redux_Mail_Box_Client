...
const ComposeMail = () => {
    ...
    const handlerOnSubmitCompose = async (e) => {
        ...
        try {
            const response = await fetch(`https://mailboxclient-ad1a1-default-rtdb.firebaseio.com/boxMail/${senderEmail}/sendbox.json`, {
                method: "POST",
        ...
        try {
            const response = await fetch(`https://mailboxclient-ad1a1-default-rtdb.firebaseio.com/boxMail/${receiverCleanEmail}/inbox.json`, {
                method: "POST",
                body: JSON.stringify(sendComposeData)
            });
